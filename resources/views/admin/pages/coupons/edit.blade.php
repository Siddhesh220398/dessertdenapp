...
@section('breadcrumb')
{!! Breadcrumbs::render('edit_coupons', $coupon) !!}
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form id="frmcoupons" class="form-horizontal" role="form" method="POST" action="{{ route('admin.coupons.update', $coupon->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                     ...
                     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" name="name"  placeholder="Enter name" maxlength="80" value="{{ old('name', $coupon->name) }}">
                                @if ($errors->has('name'))
                    ...
                    <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                <i class="fa fa-map-marker"></i>
                                <input type="text" class="form-control" name="code"  placeholder="Enter Code" maxlength="80" value="{{ old('code', $coupon->code) }}">
                                @if ($errors->has('code'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('value') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                <i class="fa fa-map-marker"></i>
                                <input type="text" class="form-control" name="value"  placeholder="Enter Value" maxlength="80" value="{{ old('value',$coupon->value) }}">
                                @if ($errors->has('value'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('expiryDate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control"  id="expiryDate" name="expiryDate"  placeholder="Enter Expiry Date"  value="{{ old('expiryDate',$coupon->expiryDate) }}">
                    ...
                    <div class="form-group{{ $errors->has('maxCoupon') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                <i class="fa fa-map-marker"></i>
                                <input type="text" class="form-control" name="maxCoupon"  placeholder="Enter Max Coupons"  value="{{ old('maxCoupon', $coupon->maxCoupon) }}">
                    ...
                    <div class="form-group{{ $errors->has('userAllowed') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                <i class="fa fa-map-marker"></i>
                                <input type="text" class="form-control" name="userAllowed"  placeholder="Enter User Allowed"  value="{{ old('userAllowed',$coupon->userAllowed) }}">
