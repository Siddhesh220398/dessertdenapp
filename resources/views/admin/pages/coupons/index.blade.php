            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    @if (in_array('delete', $permissions))
                        <a href="{{ route('admin.coupons.destroy',0) }}" name="del_select" id="del_select" class="btn btn-circle btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected</a>
                    @endif
                    @if (in_array('add', $permissions))
                        <a href="{{ route('admin.coupons.create') }}" class="btn btn-circle btn-success"><i class="fa fa-plus"></i> Add Coupons</a>
                    @endif
                </div>
            </div>
    ...
    $(function(){
        ...
        oTable = table.dataTable({
            ...
            "columns": [
                ...
                { "title": "Max Coupons" ,"data": "maxCoupon"},
                { "title": "User Allowed" ,"data": "userAllowed"},
