    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form id="frmCity" class="form-horizontal" role="form" method="POST" action="{{ route('admin.cities.update', $city->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter name" maxlength="80" value="{{ old('name', $city->name) }}">
                                @if ($errors->has('name'))
                     ...
                     <div class="form-group" >
                        ...
                        <div class="col-md-6">
                            <select class="form-control"  name="city_type" >
                                ...
                                <option value="in" @if($city->city_type =='in') selected @endif>In</option>
                                <option value="out" @if($city->city_type =='out') selected @endif>Out</option>
