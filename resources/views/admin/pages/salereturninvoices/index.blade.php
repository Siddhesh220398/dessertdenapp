...
@section('breadcrumb')
    {!! Breadcrumbs::render('salereturninvoices') !!}
@endsection
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if (in_array('delete', $permissions))
                            <a href="{{ route('admin.invoices.destroy',0) }}" name="del_select" id="del_select" class="btn btn-circle btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected</a>
                        @endif
                        @if (in_array('add', $permissions))
                            <a href="{{ route('admin.salereturninvoices.create') }}" class="btn btn-circle btn-success"><i class="fa fa-plus"></i> Add Invoice</a>
                        @endif
                    </div>
                </div>
            ...
            oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "title": "<input type='checkbox' class='all_select'>" ,"data": "checkbox","width":"3%",searchble: false, sortable:false},
                        @endif
                    { "title": "Sale Return Invoice No" ,"data": "invoice_no"},
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.salereturninvoices.listing')}}",
                },
