    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form id="frmTimes" class="form-horizontal" role="form" method="POST" action="{{ route('admin.times.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group{{ $errors->has('startingtime') ? ' has-error' : '' }}">
                        ...
                        <div class='input-group date'>
                            <input type='text' class="form-control" name="startingtime" id="startingtime" placeholder="Pick the Starting time"  value="{{ old('startingtime') }}" />
                    ...
                    <div class="form-group{{ $errors->has('endingtime') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type='text' class="form-control" name="endingtime" id="endingtime" placeholder="Pick the Ending time"  value="{{ old('endingtime') }}" />
                            <span class="input-group-addon">
                            <span class="glyphicon glyphicon-time"></span>
                            </span>
