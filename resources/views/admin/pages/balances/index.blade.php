            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    @if (in_array('delete', $permissions))
                        <a href="{{ route('admin.balances.destroy',0) }}" name="del_select" id="del_select" class="btn btn-circle btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected</a>
                    @endif
                    @if (in_array('add', $permissions))
                        <a href="{{ route('admin.balances.create') }}" class="btn btn-circle btn-success"><i class="fa fa-plus"></i> Add Balance</a>
                    @endif
                </div>
            </div>
    ...
    $(function(){
        ...
        oTable = table.dataTable({
            ...
            "columns": [
                ...
                @endif
                { "title": "Franchise" ,"data": "franchise_id"},
                { "title": "Date" ,"data": "date"},
                { "title": "Bank/Cash" ,"data": "bank"},
                { "title": "Narration" ,"data": "narration"},
                { "title": "Credit" ,"data": "credit"},
                { "title": "Debit" ,"data": "debit"},
                { "title": "TotalBalance" ,"data": "totalBalance"},
