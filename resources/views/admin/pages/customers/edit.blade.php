...
@section('breadcrumb')
    {!! Breadcrumbs::render('edit_customers',$customer) !!}
@endsection
            ...
            <div class="profile-sidebar">
                ...
                <div class="portlet light profile-sidebar-portlet bordered">
                    ...
                    <div class="profile-userpic">
                        <img src="{{ $customer->profile }}" class="img-responsive" alt="">
                    </div>
                    <!-- END SIDEBAR USERPIC -->
                    <!-- SIDEBAR USER TITLE -->
                    <div class="profile-usertitle">
                        <div class="profile-usertitle-name"> {{$customer->first_name}} </div>
                    </div>
                            ...
                            <div class="portlet-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <form role="form" id="frmProfile" method="POST" action="{{ route('admin.customers.update', $customer->id) }}" enctype="multipart/form-data">
                                            @csrf
                                        ...
                                        @method('PUT')
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input type="text" placeholder="Enter Name" name="name" id="name"
                                                       class="form-control"
                                                       value="{{old('name',$customer->first_name)}}" maxlength="50"/>
                                                @if ($errors->has('name'))
                                    ...
                                    <div class="form-group{{ $errors->has('mobile_no') ? ' has-error' : '' }}">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input type="text" placeholder="Enter Contact No" name="mobile" id="mobile"
                                                   class="form-control"
