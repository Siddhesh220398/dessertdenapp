...
@section('breadcrumb')
{!! Breadcrumbs::render('franchisesprice') !!}
@endsection
            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    @if (in_array('delete', $permissions))
                        <a href="{{ route('admin.franchisesprice.destroy',0) }}" name="del_select" id="del_select" class="btn btn-circle btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected</a>
                    @endif
                    @if (in_array('add', $permissions))
                        <a href="{{ route('admin.franchisesprice.create') }}" class="btn btn-circle btn-success"><i class="fa fa-plus"></i> Add Franchise</a>
                    @endif
                </div>
            </div>
    ...
    $(function(){
        ...
        oTable = table.dataTable({
            ...
            "columns": [
                ...
                @endif
                { "title": "Franchise Name" ,"data": "franchise_id"},
            ...
            "pageLength": 10,
            "ajax": {
                "url": "{{route('admin.franchisesprice.listing')}}",
            },
