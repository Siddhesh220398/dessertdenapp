...
@section('breadcrumb')
    {!! Breadcrumbs::render('franchises_details', $franchise) !!}
@endsection
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="tab1">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    <label class="control-label" @if($franchise->balance <=0 )style="color: red" @else style="color: darkgreen" @endif>{{ $franchise->balance }}</label>
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="email" class="col-md-2 control-label bold">Email Address : </label>
                                <div class="col-md-4">
                                    <label class="control-label">{{ $franchise->email }}</label>
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="phone" class="col-md-2 control-label bold">Phone : </label>
                                <div class="col-md-4">
                                    <label class="control-label">{{ $franchise->mobile_no }}</label>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    <img class="img-thumbnail" src="{{ public_path($franchise->profile) }}" alt="Image">
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="profile" class="col-md-2 control-label bold">Total Orders : </label>
                                <div class="col-md-4">
                                    <label class="control-label">{{ App\Models\Order::where('franchises_id',$franchise->id)->count() }}</label>
                                </div>
                            </div>
                        </div>
