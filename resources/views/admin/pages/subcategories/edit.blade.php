...
{!! Breadcrumbs::render('edit_subcategory', $subcategory) !!}
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <form id="frmSubCategory" class="form-horizontal" role="form" method="POST" action="{{ route('admin.subcategories.update', $subcategory->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter name" maxlength="80" value="{{ old('name', $subcategory->name) }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-offset-2 col-md-2">
                            ...
                            <img src="{{ Storage::url($subcategory->image) }}" alt="Image" class="img-thumbnail" />
