...
@section('breadcrumb')
    {!! Breadcrumbs::render('salereturns') !!}
@endsection
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if (in_array('delete', $permissions))
                            <a href="{{ route('admin.salereturns.destroy',0) }}" name="del_select" id="del_select"
            ...
            oTable = table.dataTable({
                ...
                "columns": [
                        @if (in_array('delete', $permissions))
                    {
                        ...
                        @endif
                    {
                        "title": "Order No", "data": "order_id"
                    },
                    {"title": "Customer Name", "data": "customer"},

                    {"title": "Item", "data": "item"},
                    {"title": "Order Date", "data": "order_date"},
                    {"title": "Sale Return Date", "data": "date"},
                    {"title": "Franchise reason", "data": "reason_f"},
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.salereturns.listing')}}",
