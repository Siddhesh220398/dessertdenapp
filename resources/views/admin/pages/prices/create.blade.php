    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form id="frmPrices" class="form-horizontal" role="form" method="POST" action="{{ route('admin.prices.store') }}" enctype="multipart/form-data">
                    @csrf
